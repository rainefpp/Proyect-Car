      ...
      <div class="flex justify-between flex-nowrap lg:flex-col lg:gap-12" style="gap: 0;">
        ...
        <div class="w-full lg:w-1/2 lg:order-1">
          <div class="px-12 py-12 sm:p-8 rounded-xl shadow-md">
            ...
            <p class="text-lg text-white mb-8">¿Tienes preguntas o necesitas ayuda para encontrar el vehículo ideal?</p>

            <form class="space-y-6">
              <!-- Campos del formulario... -->
              <div>
                <label for="nombre" class="block text-sm font-medium text-white mb-1">Nombre y Apellido</label>
                <input type="text" id="nombre" placeholder="Franco Paredes Pardo"
                       class="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
              </div>

              <div>
                <label for="correo" class="block text-sm font-medium text-white mb-1">Correo electrónico</label>
                <input type="email" id="correo" placeholder="fparedesp@ing.ucsc.cl"
                       class="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
              </div>

              <div>
                <label for="telefono" class="block text-sm font-medium text-white mb-1">Número Telefónico</label>
                <input type="tel" id="telefono" placeholder="9XX34XX2X"
                       class="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
              </div>
